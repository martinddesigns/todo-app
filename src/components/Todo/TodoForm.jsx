...
const TodoForm = ({ setInput, input, setTodoList, todoList, edit }) => {
  ...
  return <>
    ...
    <form className='todo__form mb-15'>
      ...
      <button onClick={submitHandler} className={`bg-blue-500 hover:bg-cyan-500 font-b px-15 py-5 rounded-5 text-white block`} type='submit'>{edit ? 'Edit Task' : 'Add Task'}</button>
    </form>
  </>
}
